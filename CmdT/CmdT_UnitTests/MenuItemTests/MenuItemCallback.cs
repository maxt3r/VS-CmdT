...
namespace CmdT_UnitTests.MenuItemTests
{
	[TestClass()]
	public class MenuItemTest
	{
		...
		{
			// Create the package
			IVsPackage package = new CmdTPackage() as IVsPackage;
			...
			CommandID menuCommandID = new CommandID(Jitbit.CmdT.GuidList.guidCmdTCmdSet, (int)Jitbit.CmdT.PkgCmdIDList.cmdidCmdT);
